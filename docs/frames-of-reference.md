...
1. Share, in a live human way, the framing for this exercise (e.g. [our deck](https://docs.google.com/presentation/d/1fjobt8IsaSxLY0gsShJxLqkYNAU6rVbZDyRkfOcZzBU/edit#slide=id.p)) to ensure everyone gets the concept.
2. Customize [the questionnaire](https://docs.google.com/forms/d/13TyHs8ylQI-vF35y4GMRYCXLTNll-5TdTFQATakUP7g/edit) to your project to make the questions directly connect to the context you're working in. Consider adding a description/helper text to each question for added context ( [example](https://docs.google.com/forms/d/1-v4Fjc0uTrHg171qOFbVqkifs3q9bgLNsgwNmzcIZLE/edit?usp=sharing)).
...
- [The deck](https://docs.google.com/presentation/d/1fjobt8IsaSxLY0gsShJxLqkYNAU6rVbZDyRkfOcZzBU/edit#slide=id.p)
- [Questionnaire template](https://docs.google.com/forms/d/13TyHs8ylQI-vF35y4GMRYCXLTNll-5TdTFQATakUP7g/edit) ( **copy, do not use directly**)
- [Example questionnaire](https://docs.google.com/forms/d/1-v4Fjc0uTrHg171qOFbVqkifs3q9bgLNsgwNmzcIZLE/edit?usp=sharing)

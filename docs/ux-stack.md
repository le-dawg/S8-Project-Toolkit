...
1. Draw out the UX stack on a digital or physical whiteboard.
2. Explain each piece of the stack to the team, client, stakeholder(s), product owner
3. Begin to fill in and populate the words and phrases that align with each section of the stack.
4. Use this narrative to refine metrics, value props, and feature/solution ideas

![ux stack example](/assets/images/ux-stack.png)

## Resources

[Miro template](https://miro.com/app/board/o9J_l9N5Xh8=/?moveToWidget=3074457360666772494&cot=14)
